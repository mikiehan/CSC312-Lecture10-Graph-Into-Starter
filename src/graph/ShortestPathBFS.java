 ...
 *  Dependencies: graph.Graph.java Queue.java Stack.java lib.StdOut.java
...
public class ShortestPathBFS {
     ...
     */
    public ShortestPathBFS(Graph G, Iterable<Integer> sources) {
    ...
    public static void main(String[] args) {
        In in = new In("tinyGConn.txt");
        Graph G = new Graph(in);
        // lib.StdOut.println(G);

        int s = Integer.parseInt(args[1]);
        ShortestPathBFS bfs = new ShortestPathBFS(G, s);
